...
router.get('/championm', function(req, res) {
  res.render('forms/championm', {userId: req.query.id});
});

router.get('/championl', function(req, res) {
  res.render('forms/championl', {userId: req.query.id});
});

router.get('/verifiedy', function(req, res) {
  res.render('forms/verifiedy', {userId: req.query.id});
});

router.get('/starter3', function(req, res) {
  res.render('forms/starter3', {userId: req.query.id});
});

router.get('/starter6', function(req, res) {
  res.render('forms/starter6', {userId: req.query.id});
});

router.get('/starter12', function(req, res) {
  res.render('forms/starter12', {userId: req.query.id});
});
